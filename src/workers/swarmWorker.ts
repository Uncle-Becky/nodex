...
let agent: SwarmAgent | null = null;
...
self.onmessage = (event: MessageEvent) => {
  ...
  try {
    ...
    switch (type) {
      ...
      case 'INIT_SWARM_AGENT':
        if (!agent) {
          ...
          agent = new SwarmAgent(agentId, initialPosition);
      ...
      default:
        console.warn(`Unknown message type in swarm worker: ${type}`);
    }
    ...
    console.error('Error in swarm worker:', error);
