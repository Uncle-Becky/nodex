...
import type { NetworkMetrics, SwarmMetrics } from '../managers/AgentManager';
  ...
  useEffect(() => {
    const unsubscribe = eventBus.subscribe('SYSTEM_EVENT', event => {
      ...
      if (payload.id === 'analytics_update') {
        ...
        setRecentEvents(
          (payload.meta as { data: { messageHistory: BusEvent[] } }).data
            .messageHistory
        );
      }
    });
